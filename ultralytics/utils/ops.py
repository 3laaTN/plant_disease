...
def non_max_suppression(
    ...
    for xi, x in enumerate(prediction):  # image index, image inference
        ...
        # i = NMS(boxes, scores, iou_thres) # DIoU-NMS / CIoU-NMS / EIoU-NMS/ GIoU-NMS / SIoU-NMS
...
from .metrics import box_iou, bbox_iou


def NMS(boxes, scores, iou_thres, GIoU=False, DIoU=False, CIoU=False, EIoU=True, SIoU=False):
